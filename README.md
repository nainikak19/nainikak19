...
I'm a passionate **Java Backend Developer** and an aspiring **AWS & DevOps Engineer**, currently immersed in building secure, scalable, and real-world backend systems using the **Spring Framework ecosystem**. 
